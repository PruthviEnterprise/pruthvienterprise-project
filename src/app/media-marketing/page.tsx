...
const MediaMarketing = () => {
  const services = [
    {
      ...
      description:
        "Build a strong digital identity with strategic content and consistent engagement.",
      features: [
    ...
    },
    {
      ...
      description: "Reach your ideal audience through targeted ad campaigns.",
      features: [
    ...
    },
    {
      ...
      description: "High-quality content designed to enhance brand value.",
      features: [
        "Product photography",
        "Promo videos & reels",
        "Corporate graphics",
    ...
    },
    {
      ...
      description:
        "We help shape your brand voice, message and online presence.",
      features: [
        "Logo & visual theme development",
        "Brand guidelines",
        "Market positioning",
  ...
  const stats = [
    { number: "1500+", label: "Successful Social Campaigns" },
    { number: "300+", label: "Active Marketing Clients" },
    { number: "25+", label: "Sectors Served" },
              ...
              >
                ...
                <h1 className="text-4xl md:text-6xl lg:text-5xl font-bold mb-6 leading-tight">
                  ...
                  <span className="text-primary">
                    Result-Driven Brand Promotion
                  </span>
                </h1>
                <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                  Pruthvi Enterprise helps businesses build a strong digital
                  presence through effective media marketing solutions. From
                  social media campaigns to digital branding, we combine
                  creativity and strategy to help your brand reach the right
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <p className="text-lg text-muted-foreground mb-12 leading-relaxed">
                  A clear, purpose-driven approach that ensures your brand
                  ...
                  {[
                    {
                      ...
                      description:
                        "We analyze your goals, audience, competitors, and brand identity to craft a communication strategy that aligns with your vision.",
                    },
                    {
                      step: "02",
                      title: "Content Creation",
                      description:
                        "Our team develops engaging visuals, impactful messages, and tailored content to showcase your brand effectively across channels.",
                    },
                    {
                      step: "03",
                      title: "Campaign Execution & Optimization",
                      description:
                        "We launch campaigns, track performance, and optimize for maximum reach, engagement, and conversions.",
                    },
                  ].map((process, index) => (
                    <motion.div
                      key={index}
          ...
          <Container>
            ...
            >
              <h2 className="text-3xl font-bold mb-4">
                Driving Growth Through Creative Media Solutions
              </h2>
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Years of experience in building digital visibility and brand
        ...
        <section className="py-20 px-4">
          <Container>
            <h2 className="text-3xl font-bold mb-9 text-center">
              Our Core Media Marketing Services
            </h2>
