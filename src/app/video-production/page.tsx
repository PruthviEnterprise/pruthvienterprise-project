...
const VideoProduction = () => {
  const services = [
    {
      ...
      description:
        "Perfect for brand communication, internal training, and company overviews.",
      features: [
        "Professional scripting",
        "High-quality visuals",
        "Brand-centric messaging",
        "Suitable for presentations & websites",
      ],
    },
    {
      icon: Briefcase,
      ...
      description:
        "Impactful content that boosts engagement and drives conversions.",
      features: [
        "Product features",
        "Campaign videos",
        "Social media ads",
        "Lead-focused storytelling",
      ],
    },
    {
      icon: Clock,
      ...
      description:
        "Capture the energy and highlights of your events with crisp, dynamic footage.",
      features: [
        "Conferences",
        "Exhibitions & launches",
        "Award ceremonies",
        "Live multi-camera recording",
      ],
    },
    {
      icon: Shield,
      title: "Animated & Explainer Videos",
      description: "Simplifying complex ideas through engaging animations.",
      features: [
        "2D & 3D animation",
  ...
  const stats = [
    { number: "3000+", label: "Videos Successfully Delivered" },
    { number: "400+", label: "Brands & Agencies Served" },
    { number: "40+", label: "Industries Covered" },
    { number: "98%", label: "Client Satisfaction Rating" },
  ];
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <h1 className="text-4xl md:text-6xl lg:text-5xl font-bold mb-6 leading-tight">
                  Storytelling That Amplifies{" "}
                  <span className="text-primary">Your Brand</span>
                </h1>
                <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                  From concept to final cut, Pruthvi Enterprise delivers
                  high-quality video content that helps businesses communicate,
                  influence, and grow. Our team blends creativity, technology,
                  and strategy to produce videos that capture attention and
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <h2 className="text-4xl md:text-5xl font-bold mb-8">
                  How We Create Powerful Visual Stories
                </h2>
                <p className="text-lg text-muted-foreground mb-12 leading-relaxed">
                  A clear, organized, and collaborative workflow that ensures
                  every project is delivered with precision, creativity, and
                  ...
                  {[
                    {
                      ...
                      description:
                        "We begin by understanding your brand goals, target audience, key messages, and desired style. This helps us craft the perfect storyline and video concept tailored to your objectives.",
                    },
                    {
                      step: "02",
                      title: "Scripting & Pre-Production",
                      description:
                        "Our team prepares scripts, storyboards, shot lists, and logistics. We plan locations, resources, and technical requirements to ensure a smooth filming experience.",
                    },
                    {
                      step: "03",
                      title: "Filming & Production",
                      description:
                        "Using high-end cameras, lighting, and audio equipment, our production crew captures cinematic visuals that bring your message to life.",
                    },
                  ].map((process, index) => (
                    <motion.div
                      key={index}
          ...
          <Container>
            ...
            >
              <h2 className="text-3xl font-bold mb-4">
                Results That Showcase Our Expertise
              </h2>
              <p className="text-muted-foreground max-w-2xl mx-auto">
                With years of experience in cinematic storytelling and
                commercial content creation, we have delivered impactful videos
