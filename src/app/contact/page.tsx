            ...
            <div className="space-y-8">
              ...
              <div className="grid sm:grid-cols-3 gap-6">
                ...
                >
                  ...
                  <a href="tel:+15550000000" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                    +1 (555) 000-0000
                  </a>
                </motion.div>
                ...
                >
                  ...
                  <a href="mailto:hello@company.com" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                    hello@company.com
                  </a>
                </motion.div>
