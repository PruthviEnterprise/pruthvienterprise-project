...
const OutdoorAds = () => {
  const services = [
    {
      ...
      description:
        "High-visibility outdoor placements for maximum brand reach.",
      features: [
        "Premium and prime locations",
        "LED and static hoardings",
        "Citywide coverage",
        "24/7 brand exposure",
      ],
    },
    {
      ...
      description:
        "Large-format displays ideal for highways and high-speed roads.",
      features: [
    ...
    },
    {
      ...
      description: "Promote your brand on the move and reach a wider audience.",
      features: [
        "Bus ads",
    ...
    {
      icon: Shield,
      title: "Digital Outdoor Displays (DOOH)",
      description: "Modern and dynamic advertising formats.",
      features: [
        "LED screens",
        "Animated visuals",
  ...
  const stats = [
    { number: "2000+", label: "Outdoor Campaigns Executed" },
    { number: "300+", label: "Brands Advertised" },
    { number: "80+", label: "Prime Locations Covered" },
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                  At Pruthvi Enterprise, we help brands stand out in the public
                  space with strategically placed, eye-catching outdoor
                  advertisements. From billboards to transit media, our outdoor
                  ad solutions ensure your message reaches the right audience at
                  the right time.
                </p>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                <Badge variant="outline" className="mb-4">
                  Our Outdoor Advertising Process
                </Badge>
                <h2 className="text-4xl md:text-5xl font-bold mb-8">
                  How We Deliver High-Impact Outdoor Campaigns
                </h2>
                <p className="text-lg text-muted-foreground mb-12 leading-relaxed">
                  A clear and efficient workflow designed to maximize your brand
                  visibility and ROI.
                </p>
                ...
                <div className="space-y-8">
                  {[
                    {
                      step: "01",
                      title: "Brand & Campaign Understanding",
                      description:
                        "We start by understanding your brand goals, target audience, locations, and campaign duration to craft a perfect outdoor advertising strategy.",
                    },
                    {
                      step: "02",
                      title: "Site Selection & Planning",
                      description:
                        "Using data-driven insights and on-ground research, we identify high-traffic locations and the best media formats for maximum outreach.",
                    },
                    {
                      step: "03",
                      title: "Design, Approval & Production",
                      description:
                        "Our creative team develops captivating visuals tailored for outdoor visibility. Once approved, we handle printing, fabrication, and installation with precision.",
                    },
                  ].map((process, index) => (
                    <motion.div
                      key={index}
          ...
          <Container>
            ...
            >
              <h2 className="text-3xl font-bold mb-4">
                Proven Results in Outdoor Campaigns
              </h2>
              <p className="text-muted-foreground max-w-2xl mx-auto">
                With years of experience in outdoor media and brand promotion,
                we have created impactful campaigns across multiple cities and
                industries.
              </p>
            </motion.div>
